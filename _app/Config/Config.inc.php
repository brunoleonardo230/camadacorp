...
if (!$WorkControlDefineConf):
    ...
    if($_SERVER['HTTP_HOST'] == 'http://camadacorp.test'):
        define('BASE', 'http://camadacorp.test/site/gym'); //Url Raiz do Site no localhost
    else:
        define('BASE', 'http://camadacorp.com.br/site/gym'); //Url Raiz do Site no Servidor
    endif;
    define('THEME', 'gym'); //Template do Site
endif;
