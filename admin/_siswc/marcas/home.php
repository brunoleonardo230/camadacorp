...
<header class="dashboard_header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <div class="dashboard_header_title">
        <h1 class="icon-star-full">Marcas Parceiras</h1>
    ...
    <div class="dashboard_header_search">
        <a class="btn_header btn_darkgreen icon-plus add"> Nova Marca Parceira</a>
    </div>
</header>
<div class="dashboard_content">
    ...
    <div class="refs box box100" id="cadastro">
        <div class="panel_header darkgreen">
            <h2 class="icon-bubbles3">Dados Sobre a Marca Parceira</h2>
        </div>
        <div class="panel">
    ...
    <div class="refs box box100" id="base">
        ...
        if (!$Read->getResult()):
            ...
            foreach ($Read->getResult() as $Brands):
                ...
                echo"<article class='box box25 post_single js-rel-to' id='{$brand_id}'> <header class='wc_normalize_height'> <img alt='{$brand_name}' title='{$brand_name}' style='width: 100%' src='{$BrandImage}'/> <div class='info'> <p class='icon-star-full'><b>Marca Parceira: </b> {$brand_name}</p> </div> </header> <footer class='al_center'> <span title='Editar Marca Parceira' class='btn_header btn_darkgreen icon-pencil icon-notext jbs_action' cc='Brands' ca='edit' rel='{$brand_id}'></span> <span title='Excluir Marca Parceira' class='j_delete_action icon-bin icon-notext btn_header btn_red' callback='Brands' callback_action='delete' id='{$brand_id}'></span> </footer> </article>";
            endforeach;
