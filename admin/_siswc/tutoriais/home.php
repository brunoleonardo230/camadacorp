...
<header class="dashboard_header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <div class="dashboard_header_search">
        ...
        <form style="width: 100%; display: inline-block;" name="searchCategoriesPost" action="" method="post" enctype="multipart/form-data" class="ajax_off">
            ...
            <button title='Pesquisar' class="btn_header btn_darkgreen icon-search icon-notext"></button>
            <a href="#" title='Novo Tutorial' class="btn_header btn_darkgreen icon-plus m_top j_create_modal" data-modal=".js-tutorial">Novo Tutorial </a>
        </form> 
    </div>
</header>
        ...
        foreach ($Read->getResult() as $TUTORIAL):
            ...
            echo "<article class='box box25 post_single js-rel-to' id='{$tutorial_id}'>   
                ...
                <div class='post_single_actions'>
                    <span title='Assistir Tutorial' class='post_single_center icon-play icon-notext btn_header btn_green j_video_modal' callback='Tutoriais' id='{$tutorial_id}'></span>
                    <span title='Editar Tutorial' class='btn_header btn_darkgreen icon-notext icon-pencil j_edit_modal' callback='Tutoriais' callback_action='edit' id='{$tutorial_id}'></span>
...
<div class="bs_ajax_modal js-tutorial" style="display: none;">
    <div class="bs_ajax_modal_box">
        <p class="bs_ajax_modal_title green"><span class="icon-film">Cadastrar Tutorial</span></p>
...
<div class="bs_ajax_modal js-video" style="display: none;">
    <div class="bs_ajax_modal_box_video">
        <p class="bs_ajax_modal_title green"><span class="icon-film">Assistir Tutorial</span></p>
