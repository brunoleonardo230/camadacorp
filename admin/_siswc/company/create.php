...
<header class="dashboard_header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <div class="dashboard_header_search" style="font-size: 0.875em; margin-top: 16px;">
        <a title="Voltar" class="btn_header btn_darkgreen icon-undo2" href="dashboard.php?wc=company/home">Voltar</a>
    </div>
</header>
...
<div class="dashboard_content">
    <div class="box box70">
        ...
        <article class="wc_tab_target ds_none" id="blocks">
            <div class="panel_header darkgreen">
                <span>
                    <a title="Novo Bloco" href="dashboard.php?wc=company/blocks&company=<?= $company_id; ?>" class="btn_header btn_green icon-plus icon-notext"></a>
                </span>
                    ...
                    foreach ($Read->getResult() as $Blocks):
                        ...
                        echo "<div class='single_user_addr js-rel-to' id='{$block_id}'>
                            ...
                            <div class='single_user_addr_actions'>
                                <a title='Editar Bloco' href='dashboard.php?wc=company/blocks&id={$block_id}' class='post_single_center icon-notext icon-pencil btn_header btn_green'></a>
                                <span title='Excluir Bloco' class='j_delete_action icon-bin icon-notext btn_header btn_red' callback='Company' callback_action='delete_block' id='{$block_id}'></span>
                            </div>
                        </div>";
                    endforeach;
                endif;
                                ...
                                foreach ($Read->getResult() as $image):
                                    ...
                                    <div class='panel_gallery_image wc_draganddrop' callback='Company' callback_action='gallery_image_order' id='<?= $gallery_image_id; ?>' data-id="<?= $gallery_image_id; ?>" >
                                        ...
                                        <div class='panel_gallery_action'>
                                            <ul class="buttons">
                                            <li><span title="Editar Imagem" class="j_edit_action icon-pencil icon-notext btn_header btn_darkgreen"></span></li>
                                            <li><span title="Excluir Imagem" rel='panel_gallery_image' class='j_delete_action icon-bin icon-notext btn_header btn_red' callback='Company' callback_action='gallery_image_delete' id="<?= $gallery_image_id; ?>"></span></li>
                                            </ul>
                                        </div>
                ...
                <div class="modal_legend">
                    <div class="modal_legend_content">
                        <form class="j_form_legend" action="" method="post" enctype="multipart/form-data">
                            ...
                            <button title="ATUALIZAR" class="btn btn_darkgreen icon-share">ATUALIZAR</button>
                            <div class="clear"></div>
                        </form>  
                    </div>    
                </div>
        ...
        <article class="wc_tab_target ds_none" id="differentials">
            <div class="panel_header darkgreen">
                <span>
                    <a title="Novo Diferencial" href="dashboard.php?wc=company/differentials&company=<?= $company_id; ?>" class="btn_header btn_green icon-plus icon-notext"></a>
                </span>
                ...
                if (!$Read->getResult()):
                    ...
                    foreach ($Read->getResult() as $Differentials):
                        ...
                        echo "<div class='single_user_addr js-rel-to' id='{$differential_id}'>
                            ...
                            <div class='single_user_addr_actions'>
                                <a title='Editar Diferencial' href='dashboard.php?wc=company/differentials&id={$differential_id}' class='post_single_center icon-notext icon-pencil btn_header btn_darkgreen'></a>
                                <span title='Excluir Diferencial' rel='single_user_addr' class='j_delete_action icon-notext icon-bin btn_header btn_red' callback='Company' callback_action='delete_differential' id='{$differential_id}'></span>
                            </div>
                        </div>";    
                    endforeach;
                endif;
        ...
        <article class="wc_tab_target ds_none" id="faq">
            <div class="panel_header darkgreen">
                <span>
                    <a href="#" title='Nova FAQ' class="btn_header btn_green icon-plus icon-notext j_create_faq_modal" data-modal=".js-faq"></a>
                </span>
                ...
                if (!$Read->getResult()):
                    ...
                    foreach ($Read->getResult() as $FAQ):
                        ...
                        echo "<div class='single_user_addr js-rel-to' id='{$faq_id}'>
                            ...
                            <div class='single_user_addr_actions'>
                                <span title='Editar FAQ' class='btn_header btn_darkgreen icon-notext icon-pencil j_edit_faq_modal' callback='Company' callback_action='edit' id='{$faq_id}'></span>
                                <span title='Excluir FAQ' class='j_delete_action icon-bin icon-notext btn_header btn_red' callback='Company' callback_action='delete_faq' id='{$faq_id}'></span>
                                </div>
                            </div>";    
                    endforeach;
                endif;
            ...
            <div class="bs_ajax_modal js-faq" style="display: none;">
                <div class="bs_ajax_modal_box">
                    <p class="bs_ajax_modal_title green"><span class="icon-info">Cadastrar FAQ</span></p>
