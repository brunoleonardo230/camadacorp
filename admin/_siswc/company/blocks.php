...
<header class="dashboard_header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <div class="dashboard_header_search" style="font-size: 0.875em; margin-top: 16px;">
        <a title="Voltar" class="btn_header btn_green icon-undo2" href="dashboard.php?wc=company/create&id=<?= $company_id; ?>">Voltar</a>
        <a title="Novo Bloco" href="dashboard.php?wc=company/blocks&company=<?= $company_id; ?>" class="btn_header btn_darkgreen icon-plus">Novo Bloco</a>
    </div>
</header>
