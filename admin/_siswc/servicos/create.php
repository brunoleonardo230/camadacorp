...
<header class="dashboard_header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <div class="dashboard_header_search" style="font-size: 0.875em; margin-top: 16px;">
        <a class="btn_header btn_darkgreen icon-undo2" title="Voltar" href="dashboard.php?wc=servicos/home">Voltar</a>
    </div>
</header>
...
<div class="dashboard_content">
    <div class="box box70">
             ...
             <form class="auto_save" name="service_info" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="panel">
                    ...
                    <label class="label">
                        ...
                        <input name="service_title" style="font-size: 1.3em;" value="<?= $service_title; ?>" placeholder="Título do Serviço" required/>
                    </label>
					
					<label class="label">
						<span class="legend">Preço do Serviço:</span>
						<input name="service_price" class="mask-money" value="<?= (!empty($service_price) ? number_format($service_price, 2, ',', '.') : null); ?>" placeholder="Informe o Preço do Serviço" required/>
					</label>
                    ...
                    <div class="box box30">
                        <label class="label">
                            ...
                            <select name="service_icon_type" class="j_icon" required>
                                ...
                                <option value="1" <?= ($service_icon_type == 1 ? 'selected="selected"' : ''); ?>>Imagem</option>
                                <option value="2" <?= ($service_icon_type == 2 ? 'selected="selected"' : ''); ?>>Texto</option>
                            </select>
                        </label>
                        ...
                        <div class="j_icon_image">    
                            ...
                            <img class="service_icon" style="width: 100%;" src="../tim.php?src=<?= $Image; ?>&w=<?= IMAGE_W; ?>&h=<?= IMAGE_H; ?>" alt="" title=""/>
                        ...
                        <div class="j_icon_text">        
                            <label class='label'>
                                <span class='legend'>Ícone do Serviço:</span>
                                <input value='<?= $service_icon_text; ?>' type='text' name='service_icon_text' placeholder='Informe o Ícone' />
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="box box70">
                        <label class="label">
                            ...
                            <textarea class="work_mce" rows="50" name="service_content"><?= $service_content; ?></textarea>
                        </label>    
                    </div>
                    ...
                    <div class="wc_actions" style="text-align: center">
                        ...
                        <div class="switch__container">
                          <input value='1' id="switch-shadow" class="switch switch--shadow" type="checkbox" name='service_status' <?= ($service_status == 1 ? 'checked' : ''); ?>>
        ...
        <article class="wc_tab_target ds_none" id="images">
            <form class="auto_save" name="service_images" action="" method="post" enctype="multipart/form-data">
                <input type="hidden" name="callback" value="Services"/>
                <input type="hidden" name="callback_action" value="service_images"/>
                <input type="hidden" name="service_id" value="<?= $ServiceId; ?>"/>
                ...
                <div class="panel">
                    <div class="box box50">
                        <?php
                        $Image = (file_exists("../uploads/{$service_image_one}") && !is_dir("../uploads/{$service_image_one}") ? "uploads/{$service_image_one}" : 'admin/_img/no_avatar.jpg');
                        ?>
                        <label class="label">
                            <span class="legend border_bottom_title">Imagem 1:</span>
                        </label>    
                        <img class="service_image_one" style="width: 100%;" src="../tim.php?src=<?= $Image; ?>&w=<?= IMAGE_W; ?>&h=<?= IMAGE_H; ?>" alt="" title=""/>
                        
                        <label class="label">
                            <input type="file" class="wc_loadimage" name="service_image_one"/>
                        </label>        
                    </div>
                    
                    <div class="box box50">
                        <?php
                        $Image = (file_exists("../uploads/{$service_image_two}") && !is_dir("../uploads/{$service_image_two}") ? "uploads/{$service_image_two}" : 'admin/_img/no_avatar.jpg');
                        ?>
                        <label class="label">
                            <span class="legend border_bottom_title">Imagem 2:</span>
                        </label> 
                        
                        <img class="service_image_two" style="width: 100%;" src="../tim.php?src=<?= $Image; ?>&w=<?= IMAGE_W; ?>&h=<?= IMAGE_H; ?>" alt="" title=""/>
                        
                        <label class="label">
                            <input type="file" class="wc_loadimage" name="service_image_two"/>
                        </label>        
                    </div>
        ...
        <article class="wc_tab_target ds_none" id="types">
            <div class="panel_header darkgreen">
                <span>
                    <a title="Novo Tipo" href="dashboard.php?wc=servicos/types&servicos=<?= $service_id; ?>" class="btn_header btn_green icon-plus icon-notext"></a>    
                </span>
                    ...
                    foreach ($Read->getResult() as $Types):
                        ...
                        echo "<div class='single_user_addr js-rel-to' id='{$service_type_id}'>
                            ...
                            <div class='single_user_addr_actions'>
                                <a title='Editar Tipo' href='dashboard.php?wc=servicos/types&id={$service_type_id}' class='post_single_center icon-notext icon-pencil btn_header btn_darkgreen'></a>
    ...
    <div class="box box30">
        ...
        ?>
        <img class="service_image" style="width: 100%;" src="../tim.php?src=<?= $Image; ?>&w=<?= IMAGE_W; ?>&h=<?= IMAGE_H; ?>" alt="" title=""/>
