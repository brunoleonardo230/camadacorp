...
<div class="dashboard_content">
    ...
    <div class="wc_api_new">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="licene_key" value="" placeholder="License Key: bdc807-383f8d-83daafb7-ae87d8" required="required"/><button title="APLICAR CHAVE" class="btn btn_darkgreen">APLICAR CHAVE <img class="form_load none" style="margin-left: 10px;" alt="Enviando Requisição!" title="Enviando Requisição!" src="_img/load.svg"/></button>
        </form>
