...
<div class="dashboard_content">
    <div class="wc_api_new">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input required type="text" name="api_key" value="" placeholder="API Key, Ex: www.workcontrol.com.br"/><button title="Criar APP" class="btn btn_darkgreen">Criar APP <img class="form_load none" style="margin-left: 6px; margin-bottom: 9px;" alt="Enviando Requisição!" title="Enviando Requisição!" src="_img/load.svg"/></button>
        </form>
