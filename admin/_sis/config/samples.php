        ...
        <div class="tab_contents">
            <div class="wc_tab_target wc_active" id="panels">
                <div class="box box50">
                    <div class="panel_header darkgreen">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_green icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_green icon-notext icon-embed2 wc_clip" rel="panel_header_icon_action_subtitle"></a>
                        </span>
                ...
                <div class="box box50">    
                    <div class="panel_header darkgreen">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_green icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_green icon-notext icon-embed2 wc_clip" rel="panel_header_icon_subtitle"></a>
                        </span>
                ...
                <div class="box box50">
                    <div class="panel_header darkgreen">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_green icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_green icon-notext icon-embed2 wc_clip" rel="panel_header_action_subtitle"></a>
                        </span>
                ...
                <div class="box box50">    
                    <div class="panel_header darkgreen">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_green icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_green icon-notext icon-embed2 wc_clip" rel="panel_header_subtitle"></a>
                        </span>
                        <h2>Título do Painel</h2>
                        <p>Subtítulo do Painel</p>
                    </div>
                ...
                <div class="box box50">
                    <div class="panel_header darkgreen">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_green icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_green icon-notext icon-embed2 wc_clip" rel="panel_header_icon"></a>
                        </span>
                        <h2><span class="icon-command">Título do Painel</span></h2>
                    </div>
                    <div class="panel">
                ...
                <div class="box box50">    
                    <div class="panel_header darkgreen">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_green icon-notext icon-link"></a>
                            <a href="javascript:void(0)" class="btn_header btn_green icon-notext icon-embed2 wc_clip" rel="panel_header_default"></a>
                        </span>
                        <h2 class="icon-command">Título do Painel</h2>
                    </div>
                    <div class="panel">
                ...
                <div class="box box100">
                    ...
                    <div class="panel_footer">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_green icon-notext icon-embed2 wc_clip" rel="panel_footer"></a>
                        </span>
                ...
                <div class="box box100">
                    ...
                    <div class="panel_footer_external">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_green icon-notext icon-embed2 wc_clip" rel="panel_footer_external"></a>
                        </span>
            ...
            <div class="wc_tab_target ds_none" id="boxes">
                ...
                <div class="box box100">
                    <div class="panel_header darkgreen">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_green icon-notext icon-embed2 wc_clip" rel="box100"></a>
                        </span>
                        <h2>BOX 100</h2>
                    </div>
                </div>
                ...
                <div class="box box50">
                    <div class="panel_header darkgreen">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_green icon-notext icon-embed2 wc_clip" rel="box50"></a>
                        </span>
                        <h2>BOX 50</h2>
                    </div>
                </div>
                ...
                <div class="box box33">
                    <div class="panel_header darkgreen">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_green icon-notext icon-embed2 wc_clip" rel="box33"></a>
                        </span>
                        <h2>BOX 33</h2>
                    </div>
                </div>
                ...
                <div class="box box25">
                    <div class="panel_header darkgreen">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_green icon-notext icon-embed2 wc_clip" rel="box25"></a>
                        </span>
                        <h2>BOX 25</h2>
                    </div>
                </div>
                ...
                <div class="box box30">
                    <div class="panel_header darkgreen">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_green icon-notext icon-embed2 wc_clip" rel="box30"></a>
                        </span>
                        <h2>BOX 30</h2>
                    </div>
                </div>
                ...
                <div class="box box70">
                    <div class="panel_header darkgreen">
                        <span>
                            <a href="javascript:void(0)" class="btn_header btn_green icon-notext icon-embed2 wc_clip" rel="box70"></a>
                        </span>
                        <h2>BOX 70</h2>
                    </div>
                </div>
            ...
            <div class="wc_tab_target ds_none" id="forms">
                <div class="box box100">
                    ...
                    <div class="panel_header darkgreen">
                        <span>
                            <a href="javacript:void(0)" class="btn_header btn_green icon-embed2 icon-notext wc_clip" rel="form"></a>
                        </span>
                    ...
                    <div class="panel">
                        <form>
                            ...
                            <label class="label">
                                <input type="submit" name="titulo" value="Enviar" class="btn btn_darkgreen fl_right"/>
                            </label>
                        </form>
                        <div class="clear"></div>
                    </div>
            ...
            <div class="wc_tab_target ds_none" id="buttons">
                <div class="box_content">
                    ...
                    <p>Tamanho:</p>
                    <a href="javascript:void(0)" class="btn btn_darkgreen">Botão Tamanho Padrão</a>
                    <a href="javascript:void(0)" class="btn btn_darkgreen btn_small">Botão .btn_small</a>
                    <a href="javascript:void(0)" class="btn btn_darkgreen btn_medium">Botão .btn_medium</a>
                    <a href="javascript:void(0)" class="btn btn_darkgreen btn_large">Botão .btn_large</a>
                    <a href="javascript:void(0)" class="btn btn_darkgreen btn_xlarge">Botão .btn_xlarge</a>
                    <a href="javascript:void(0)" class="btn btn_darkgreen btn_xxlarge">Botão .btn_xxlarge</a>
                    <a href="javascript:void(0)" class="btn_big btn_darkgreen btn_xxlarge">Botão .btn_big</a>
                    ...
                    <p>Borda:</p>
                    <a href="javascript:void(0)" class="btn_header btn_darkgreen">Botão Borda Padrão</a>
                    <a href="javascript:void(0)" class="btn btn_darkgreen rounded">Botão .rounded</a>
                    <a href="javascript:void(0)" class="btn_header btn_darkgreen icon-calendar icon-notext rounded"></a> - icon-calendar icon-notext rounded
...
<div class="panel_header">
    <span>
        <a href="javascript:void(0)" class="btn_header btn_darkblue icon-notext icon-link"></a>
    </span>
    <h2><span class="icon-command">Título do Painel</span></h2>
    <p class="subtitle">Subtítulo do Painel</p>
</div>
