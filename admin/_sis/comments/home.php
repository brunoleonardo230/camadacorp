...
<header class="dashboard_header">
    ...
    <div class="dashboard_header_search">
        <a title="Recarregar Comentários" href="dashboard.php?wc=comments/home" class="btn_header btn_green icon-undo2">Voltar</a>
    ...
    <section class="box box100">
        ...
        <div class="panel">
            ...
            if (!$Read->getResult()):
                ...
                $SupportStatusClass = [1 => 'btn_green icon-bubbles3', 2 => 'btn_red icon-bubble2', 3 => 'btn_green icon-bubble2'];
