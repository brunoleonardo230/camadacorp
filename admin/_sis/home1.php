...
<div class="dashboard_content">
    <div class="box box25">
        <div class="panel_header darkgreen">
            <span>
                <a href="javascript:void(0)" class="btn_header btn_green icon-loop icon-notext" id="loopDashboard"></a>
            </span>
            <h2 class="icon-earth">ONLINE AGORA:</h2>
        </div>
        <div class="panel_dash_darkgreen dashboard_onlinenow">
            <?php
    ...
    <div class="box box25 dashboard_stats">
        <div class="panel_header darkgreen_light">
            <h2 class="icon-stats-dots">HOJE:</h2>
        </div>
        <div class="panel_dash_darkgreen_light">
            <?php
    ...
    <div class="box box25 dashboard_stats">
        <div class="panel_header green_light">
            <h2 class="icon-stats-dots">TOTAL:</h2>
        </div>
        <div class="panel_dash_green_light">
            <?php
                        ...
                        echo "
                                <article>
                                   ...
                                   <p>" . str_pad($ResultPosts + $ResultPdts, 4, 0, STR_PAD_LEFT) . " RESULTADOS</p>
                                    <p>
                                        <button title='Publicar' class='btn_header btn_darkgreen icon-notext icon-checkmark wc_tooltip j_wc_action' data-callback='Search' data-callback-action='publish' data-value='$search_id'><span class='wc_tooltip_balloon'>Publicar</span></button>
