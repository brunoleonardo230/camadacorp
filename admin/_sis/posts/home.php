...
<header class="dashboard_header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <div class="dashboard_header_search">
        ...
        <form style="width: 100%; display: inline-block;" name="searchCategoriesPost" action="" method="post" enctype="multipart/form-data" class="ajax_off">
            ...
            <button title="Pesquisar" class="btn_header btn_darkgreen icon icon-search icon-notext m_mobile_icon"></button>
        </form>        
    </div>
</header>
...
<div class="dashboard_content">
    ...
    if (!$Read->getResult()):
        ...
        foreach ($Read->getResult() as $POST):
            ...
            $PostStatus = ($post_status == 1 && strtotime($post_date) >= strtotime(date('Y-m-d H:i:s')) ? '<span class="btn_header btn_green icon-clock icon-notext wc_tooltip"><span class="wc_tooltip_baloon">Agendado</span></span>' : ($post_status == 1 ? '<span class="btn_header btn_green icon-checkmark icon-notext wc_tooltip"><span class="wc_tooltip_baloon">Publicado</span></span>' : '<span class="btn_header btn_yellow icon-warning icon-notext wc_tooltip"><span class="wc_tooltip_baloon">Pendente</span></span>'));
            ...
            echo "<article class='box box25 post_single js-rel-to' id='{$post_id}'>           
                <div class='post_single_cover'>
                    ...
                    <div class='post_single_status'>
                        ...
                        {$PostStatus}
                        " . (APP_POSTS_INSTANT_ARTICLE && $post_instant_article == '1' ? "<span class='btn_header btn_green icon-facebook2 icon-notext wc_tooltip'><span class='wc_tooltip_baloon'>Instant Article</span></span>" : '') . " 
                    </div>
                ...
                <div class='post_single_actions'>
                    <a title='Editar Artigo' href='dashboard.php?wc=posts/create&id={$post_id}' class='post_single_center icon-pencil icon-notext btn_header btn_darkgreen'></a>
