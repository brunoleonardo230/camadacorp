...
class Seo {
    ...
    private function setPach() {
        ...
        elseif ($this->File == 'servicos'):
            ...
            $this->Description = SITE_DESC;
            $this->Image = INCLUDE_PATH . '/images/default.jpg';
        elseif ($this->File == 'aulas'):
            //AULAS
            $this->Schema = 'WebSite';
            $this->Title = "Aulas - " . SITE_NAME;
            $this->Description = SITE_DESC;
            $this->Image = INCLUDE_PATH . '/images/default.jpg';
        elseif ($this->File == 'treinadores'):
            //TREINADORES
            $this->Schema = 'WebSite';
            $this->Title = "Treinadores - " . SITE_NAME;
            $this->Description = SITE_DESC;
            $this->Image = INCLUDE_PATH . '/images/default.jpg';    
        ...
        elseif ($this->File == 'galeria'):
            ...
            $this->Description = SITE_DESC;
            $this->Image = INCLUDE_PATH . '/images/default.jpg';
        elseif ($this->File == 'horarios'):
            //HORÁRIOS
            $this->Schema = 'WebSite';
            $this->Title = "Horários - " . SITE_NAME;
            $this->Description = SITE_DESC;
            $this->Image = INCLUDE_PATH . '/images/default.jpg';
