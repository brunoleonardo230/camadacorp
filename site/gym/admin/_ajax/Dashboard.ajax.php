            ...
            foreach ($Read->getResult() as $Online):
                if (!is_null($Online['online_user'])):
                    ...
                    $Name = "Visitante";
                        ...
                        $filter_url = "<a style='margin-right:6px!important' href='" . BASE . "/admin/dashboard.php?wc=onlinenow&url={$Online['online_url']}' title='Filtrar Por URL' class='btn_header btn_purple_brown btn_small icon-notext icon-filter'></a>";
                        $filter_device = "<a style='margin-right:6px!important' href='" . BASE . "/admin/dashboard.php?wc=onlinenow&dispositivo={$Online['online_device']}' title='Filtrar Por Dispositivo' class='btn_header btn_purple_brown btn_small icon-notext icon-filter'></a>";
                        $filter_city = "<a style='margin-right:6px!important' href='" . BASE . "/admin/dashboard.php?wc=onlinenow&cidade={$Online['online_city']}' title='Filtrar Por Cidade' class='btn_header btn_purple_brown btn_small icon-notext icon-filter'></a>";
                        $filter_state = "<a style='margin-right:6px!important' href='" . BASE . "/admin/dashboard.php?wc=onlinenow&estado={$Online['online_state']}' title='Filtrar Por Estado' class='btn_header btn_purple_brown btn_small icon-notext icon-filter'></a>";
                        $filter_country = "<a style='margin-right:6px!important' href='" . BASE . "/admin/dashboard.php?wc=onlinenow&pais={$Online['online_country']}' title='Filtrar Por País' class='btn_header btn_purple_brown btn_small icon-notext icon-filter'></a>";
                        $jSON['data'] .= "
                        <tr>
                            <td>{$Name}</td>
