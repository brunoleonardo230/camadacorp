...
<header class="dashboard_header">
    ...
    <div class="dashboard_header_search">
        <a title="Ver Categorias" href="dashboard.php?wc=posts/categories" class="btn_header btn_green icon-eye">Ver Categorias</a>
        <a title="Nova Categoria" href="dashboard.php?wc=posts/category" class="btn_header btn_darkgreen icon-plus">Nova Categoria</a>
    </div>
</header>
    ...
    <div class="box box100">
        ...
        <div class="panel">
            <form class="auto_save" name="category_add" action="" method="post" enctype="multipart/form-data">
                ...
                <button title="ATUALIZAR" class="btn_big btn_darkgreen icon-share fl_right">ATUALIZAR <img class="form_load none" style="margin-left: 6px; margin-bottom: 9px;" alt="Enviando Requisição!" title="Enviando Requisição!" src="_img/load.svg"/></button>
                <div class="clear"></div>
            </form>
        </div>
    </div>
