...
<header class="dashboard_header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <div class="dashboard_header_search">
        <a target="_blank" title="Ver Artigo No Site" href="<?= BASE; ?>/artigo/<?= $post_name; ?>" class="wc_view btn_header btn_darkgreen icon-eye">Ver Artigo No Site</a>
    </div>
</header>
    ...
    <div class="workcontrol_imageupload_content">
        <form name="workcontrol_post_upload" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="workcontrol_imageupload_actions">
                ...
                <button title="Enviar e Inserir" class="btn btn_blue icon-image">Enviar e Inserir <img class="form_load none" style="margin-left: 6px; margin-bottom: 9px;" alt="Enviando Requisição!" title="Enviando Requisição!" src="_img/load.svg"/></button>
            </div>
            <div class="clear"></div>
        </form>
    </div>
...
<div class="dashboard_content">
    ...
    <form class="auto_save" name="post_create" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="box box30">
            ...
            <div class="panel_header green m_top">
