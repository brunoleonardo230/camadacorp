...
<div class="dashboard_content">
    ...
    <div class="box box100">
        ...
        <div class="panel_header darkgreen">
            <span>
                <a href="javascript:void(0)" class="btn_header btn_green icon-loop icon-notext" id="loopOnlineNow"></a>
            </span>
                    ...
                    <tbody class="wc_onlinenow">
                        ...
                        if ($Read->getResult()):
                            foreach ($Read->getResult() as $Online):
                                ...
                                $filter_url = "<a style='margin-right:6px!important' href='" . BASE . "/admin/dashboard.php?wc=onlinenow&url={$Online['online_url']}' title='Filtrar Por URL' class='btn_header bar_green btn_small icon-notext icon-filter'></a>";
                                $filter_device = "<a style='margin-right:6px!important' href='" . BASE . "/admin/dashboard.php?wc=onlinenow&dispositivo={$Online['online_device']}' title='Filtrar Por Dispositivo' class='btn_header bar_green btn_small icon-notext icon-filter'></a>";
                                $filter_city = "<a style='margin-right:6px!important' href='" . BASE . "/admin/dashboard.php?wc=onlinenow&cidade={$Online['online_city']}' title='Filtrar Por Cidade' class='btn_header bar_green btn_small icon-notext icon-filter'></a>";
                                $filter_state = "<a style='margin-right:6px!important' href='" . BASE . "/admin/dashboard.php?wc=onlinenow&estado={$Online['online_state']}' title='Filtrar Por Estado' class='btn_header bar_green btn_small icon-notext icon-filter'></a>";
                                $filter_country = "<a style='margin-right:6px!important' href='" . BASE . "/admin/dashboard.php?wc=onlinenow&pais={$Online['online_country']}' title='Filtrar Por País' class='btn_header bar_green btn_small icon-notext icon-filter'></a>";
                                ?>
                                <tr>
                                    <td><?= $Name ?></td>
