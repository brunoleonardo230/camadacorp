...
<div class="dashboard_content dashboard_users">
    <div class="box box70">
        ...
        <article class="box box100 wc_tab_target" id="address" style="padding: 0; margin: 0; display: none;">
            <div class="panel_header darkgreen">
                <span>
                    <a href="dashboard.php?wc=users/address&user=<?= $user_id; ?>" class="btn_header btn_green icon-plus icon-notext a" title="Novo Endereço"></a>
                </span>
                    ...
                    foreach ($Read->getResult() as $Addr):
                        ...
                        echo "<div class='single_user_addr' id='{$Addr['addr_id']}'>
                            ...
                            <div class='single_user_addr_actions'>
                                <a title='Editar Endereço' href='dashboard.php?wc=users/address&id={$Addr['addr_id']}' class='post_single_center icon-notext icon-pencil btn_header btn_darkgreen'></a>
                                <span title='Excluir Endereço' rel='single_user_addr' class='j_delete_action icon-notext icon-bin btn_header btn_red' callback='Users' callback_action='addr_delete' id='{$Addr['addr_id']}'></span>
                            </div>
                        </div>";
                    endforeach;
                endif;
