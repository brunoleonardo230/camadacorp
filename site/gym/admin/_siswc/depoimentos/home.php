...
<header class="dashboard_header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <div class="dashboard_header_title">
        ...
        <p class="dashboard_header_breadcrumbs">
            ...
            <span class="crumb">/</span>
            <a title="Depoimentos" href="dashboard.php?wc=depoimentos/home">Depoimentos</a>
            <span class="crumb">/</span>
    ...
    <div class="dashboard_header_search">
        <a title="Novo Depoimento" class="btn_header btn_darkgreen icon-plus add"> Novo Depoimento</a>
    </div>
</header>
            ...
            foreach ($Read->getResult() as $Testi):
                ...
                echo"<article class='box box25 post_single js-rel-to' id='{$Testi['testimonial_id']}'>
                        ...
                        <footer class='al_center'>
                            <span title='Editar Depoimento' class='btn_header btn_darkgreen icon-pencil icon-notext jbs_action' cc='Testimonials' ca='edit' rel='{$Testi['testimonial_id']}'></span>
