$(document).ready(function () {
    ...
    $('html').on('click', '.js-user-toggle', function (e) {
        ...
        if (checked == 1) {
            ...
            count.html(checked + '/' + total.val() + ' Treinadores Selecionados');
        } else {
            count.html('Selecione o(s) Treinador(es)');
        }
    });
    ...
    $('html').on('click', '.js-modal-mark', function (e) {
        ...
        count.html(total.val() + '/' + total.val() + ' Treinadores Selecionados');
        value.val('all');
    });

    /* Desmarca Treinadores */
    $('html').on('click', '.js-modal-unmark', function (e) {
        ...
        count.html('Selecione o(s) Treinador(s)');
        value.val('');
    });

    /* Pesquisa Treinador Na Home */
    $('html').on('keyup', '.js-marketing-search', function () {
        ...
        $.post('_ajax/Trainees.ajax.php', data, function (data) {
