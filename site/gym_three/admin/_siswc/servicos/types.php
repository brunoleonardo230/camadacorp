...
<header class="dashboard_header">
    ...
    <div class="dashboard_header_search" style="font-size: 0.875em; margin-top: 16px;">
        <a class="btn_header btn_green icon-undo2" title="Voltar" href="dashboard.php?wc=servicos/create&id=<?= $service_id; ?>">Voltar</a>
        <a title="Novo Benefício" href="dashboard.php?wc=servicos/types&servicos=<?= $service_id; ?>" class="btn_header btn_darkgreen icon-plus">Novo Tipo</a>
    </div>
</header>
