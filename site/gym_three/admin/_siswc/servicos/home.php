...
<header class="dashboard_header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <div class="dashboard_header_search">
        <a title="Novo Serviço" href="dashboard.php?wc=servicos/create" class="btn_header btn_darkgreen icon-plus">Novo Serviço</a>
    </div>
</header>
        ...
        foreach ($Read->getResult() as $SERVICES):
            ...
            echo "<article class='box box25 post_single js-rel-to' id='{$service_id}'>           
                ...
                <div class='post_single_actions'>
                    <a title='Editar Serviço' href='dashboard.php?wc=servicos/create&id={$service_id}' class='post_single_center icon-pencil icon-notext btn_header btn_darkgreen'></a>
