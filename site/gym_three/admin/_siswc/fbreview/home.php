...
<div class="dashboard_content">
    <div class="wc_api_new">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input required type="text" name="token" value="" placeholder="PAGE ACCESS TOKEN"/><button class="btn btn_darkgreen icon-redo">Importar Reviews! <img class="form_load none" style="margin-left: 6px; margin-bottom: 9px;" alt="Enviando Requisição!" title="Enviando Requisição!" src="_img/load.svg"/></button>
        </form>
