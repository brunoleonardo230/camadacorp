...
<header class="dashboard_header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <div class="dashboard_header_search">
        ...
        <form style="width: 100%; display: inline-block;" name="searchCategoriesPost" action="" method="post" enctype="multipart/form-data" class="ajax_off">
            ...
            <button title="Pesquisar" class="btn_header btn_darkgreen icon icon-search icon-notext"></button>
        </form>        
    </div>
</header>
...
<div class="dashboard_content">
    ...
    if (!$Read->getResult()):
        ...
        foreach ($Read->getResult() as $VIDEO):
            ...
            $VideoStatus = ($videos_status == 1 && strtotime($videos_date) >= strtotime(date('Y-m-d H:i:s')) ? '<span class="btn_header btn_darkgreen icon-clock icon-notext wc_tooltip"><span class="wc_tooltip_baloon">Agendado</span></span>' : ($videos_status == 1 ? '<span class="btn_header btn_green icon-checkmark icon-notext wc_tooltip"><span class="wc_tooltip_baloon">Publicado</span></span>' : '<span class="btn_header btn_yellow icon-warning icon-notext wc_tooltip"><span class="wc_tooltip_baloon">Pendente</span></span>'));
            ...
            echo "<article class='box box25 post_single js-rel-to' id='{$videos_id}'>           
                ...
                <div class='post_single_actions'>
                    <a title='Editar Vídeo' href='dashboard.php?wc=videos/create&id={$videos_id}' class='post_single_center icon-pencil icon-notext btn_header btn_darkgreen'></a>
