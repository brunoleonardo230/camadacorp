...
<header class="dashboard_header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <div class="dashboard_header_search">
        <a target="_blank" title="Ver Vídeo No Site" href="<?= BASE; ?>/video/<?= $videos_name; ?>" class="wc_view btn_header btn_darkgreen icon-eye">Ver Vídeo No Site</a>
    </div>
</header>
    ...
    <div class="workcontrol_imageupload_content">
        <form name="workcontrol_post_upload" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="workcontrol_imageupload_actions">
                ...
                <button class="btn btn_darkgreen icon-image">Enviar e Inserir <img class="form_load none" style="margin-left: 6px; margin-bottom: 9px;" alt="Enviando Requisição!" title="Enviando Requisição!" src="_img/load.svg"/></button>
            </div>
            <div class="clear"></div>
        </form>
    </div>
...
<div class="dashboard_content">
    <form class="auto_save" name="post_create" action="" method="post" enctype="multipart/form-data">
        ...
        <article class="box box30">
            ...
            <div class="panel_header darkgreen m_top">
