...
<header class="dashboard_header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <div class="dashboard_header_search">
        <a title="Nova Pergunta" class="btn_header btn_darkgreen icon-plus icon-notext add"> Nova Pergunta</a>
    </div>
</header>
            ...
            foreach ($Read->getResult() as $FAQ):
                ...
                echo"<article class='box box25 post_single js-rel-to' id='{$faq_id}'>
                        ...
                        <footer class='al_center'>
                            <span title='Editar Pergunta' class='btn_header btn_darkgreen icon-pencil icon-notext jbs_action' cc='FAQ' ca='edit' rel='{$faq_id}'></span>
