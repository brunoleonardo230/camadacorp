...
<header class="dashboard_header">
    ...
    <div class="dashboard_header_search">
        <a title="Nova Filial" href="dashboard.php?wc=company/create" class="btn_header btn_darkgreen icon-plus">Nova Filial</a>
    </div>
</header>
        ...
        foreach ($Read->getResult() as $COMPANY):
            ...
            echo "<article class='box box25 post_single js-rel-to' id='{$company_id}'>           
                ...
                <div class='post_single_actions'>
                    <a title='Editar Empresa' href='dashboard.php?wc=company/create&id={$company_id}' class='post_single_center icon-pencil icon-notext btn_header btn_darkgreen'></a>
                    <span title='Excluir Empresa' class='j_delete_action icon-bin icon-notext btn_header btn_red' callback='Company' callback_action='delete' id='{$company_id}'></span>
                </div>
            </article>";
        endforeach;
