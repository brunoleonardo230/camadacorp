...
<header class="dashboard_header">
    ...
    <div class="dashboard_header_search">
        <a href="#" title="Cadastrar WC CODE" class="btn_header btn_darkgreen radius icon-plus j_open_modal" data-modal=".js-code">Cadastrar WC CODE</a>
    </div>
</header>

<div class="bs_ajax_modal js-codes" style="display: none;">
        <div class="bs_ajax_modal_box">
            <p class="bs_ajax_modal_title green"><span class="icon-tab">Novo Code Work Control</span></p>
            <span class="bs_ajax_modal_close icon-cross icon-notext j_close_modal" data-modal=".js-codes"></span>
            <div class="bs_ajax_modal_content scrollbar">
                ...
                ga('send', 'pageview');
                    ...
                    <div class="wc_actions" style="text-align: right">
                        <button name="public" value="1" class="btn_big btn_green icon-share">ENVIAR <img class="form_load none" style="margin-left: 6px; margin-bottom: 9px;" alt="Enviando Requisição!" title="Enviando Requisição!" src="_img/load.svg"/></button>
                    </div>
                </form>
            </div>  
...
<div class="dashboard_content">
    ...
    if (!$Read->getResult()):
        ...
        foreach ($Read->getResult() as $CODE):
            extract($CODE);
            ?>
            <article class="box box25 js-rel-to" id="<?= $code_id; ?>">
                ...
                <div class='code_single_actions'>
                    <span title="Editar" class="btn_header btn_darkgreen icon-pencil icon-notext j_edit_codes_modal" callback="Codes" id="<?= $code_id; ?>"></span>
                    <span title="Excluir" rel="code_single" class="j_delete_action icon-notext icon-bin btn_header btn_red" callback="Codes" callback_action="delete" id="<?= $code_id; ?>"></span>
                </div>
            </article>
            <?php
        endforeach;
