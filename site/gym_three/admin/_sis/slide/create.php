...
<header class="dashboard_header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <div class="dashboard_header_search">
        <a title="Ver Slides!" href="dashboard.php?wc=slide/home" class="btn_header btn_green icon-eye">Ver Slides</a>
        <a title="Novo Slide" href="dashboard.php?wc=slide/create" class="btn_header btn_darkgreen icon-plus">Novo Slide</a>
    </div>
</header>
        ...
        <article class="box box100">
            <div class="panel">
                ...
                <div class="wc_actions" style="text-align: center">
                    <button title="ATUALIZAR" name="public" value="1" class="btn_big btn_darkgreen icon-share m_top">ATUALIZAR <img class="form_load none" style="margin-left: 6px; margin-bottom: 9px;" alt="Enviando Requisição!" title="Enviando Requisição!" src="_img/load.svg"/></button>
