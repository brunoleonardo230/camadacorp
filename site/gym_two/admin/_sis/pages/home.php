...
<header class="dashboard_header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <div class="dashboard_header_search">
        <span title="Ordenar" class="btn_header btn_green icon-spinner9 wc_drag_active" title="Organizar Cursos">Ordenar</span>
        <a title="Nova Página" href="dashboard.php?wc=pages/create" class="btn_header btn_darkgreen icon-plus">Nova Página</a>
    </div>
        ...
        foreach ($Read->getResult() as $PAGE):
            ...
            echo "<article class='box box25 page_single wc_draganddrop js-rel-to' callback='Pages' callback_action='pages_order' id='{$page_id}'>
                ...
                <div class='page_single_action'>
                    <a title='Editar Página' href='dashboard.php?wc=pages/create&id={$page_id}' class='post_single_center icon-pencil icon-notext btn_header btn_darkgreen'></a>
