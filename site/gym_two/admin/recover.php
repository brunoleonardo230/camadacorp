            ...
            <div class="dash_login_box">
                ...
                <div class="dash_login_box_content radius">
                    <form class="dash_login_box_content_form basic_form" name="work_login" action="" method="post" enctype="multipart/form-data">
                        ...
                        <button title="OBTER NOVA SENHA" class="dash_btn green radius">OBTER NOVA SENHA <img class="form_load none" style="margin-left: 6px; margin-bottom: 7px;" alt="Enviando Requisição!" title="Enviando Requisição!" src="_img/load.svg"/></button>
                        <div class="clear"></div>
                    </form>
                </div>
