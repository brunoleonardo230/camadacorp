...
<header class="dashboard_header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <div class="dashboard_header_search">
        <span class="btn_header btn_green icon-spinner9 wc_drag_active" title="Ordenar">Ordenar</span>
        <a title="Nova Galeria" href="dashboard.php?wc=gallery/create" class="btn_header btn_darkgreen icon-plus">Nova Galeria</a>
    </div>
...
<div class="dashboard_content">
    ...
    if (!$Read->getResult()):
        ...
        foreach ($Read->getResult() as $GALLERY):
            extract($GALLERY);
            $gallery_status = ($gallery_status == 1 ? '<span class="icon-checkmark font_green">Publicada</span>' : '<span class="icon-warning font_yellow">Rascunho</span>');
        ...
        <div class='page_single_action'>
            <a title='Editar Galeria' href='dashboard.php?wc=gallery/create&id={$gallery_id}' class='post_single_center icon-pencil icon-notext btn_header btn_darkgreen'></a>
