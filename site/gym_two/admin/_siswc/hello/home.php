...
<header class="dashboard_header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <div class="dashboard_header_search">
        <a title="Nova Hellobar" href="dashboard.php?wc=hello/create" class="btn_header btn_darkgreen icon-plus">Nova Hellobar</a>
    </div>
        ...
        foreach ($Read->getResult() as $HELLO):
            ...
            echo "<article class='box box25 page_single hello_single js-rel-to' id='{$hello_id}'>
                ...
                <div class='page_single_action'>
                    <a title='Editar Hellobar' href='dashboard.php?wc=hello/create&id={$hello_id}' class='post_single_center icon-pencil icon-notext btn_header btn_darkgreen'></a>
