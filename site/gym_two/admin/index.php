                ...
                <div class="dash_login_box_content radius">
                    <form class="dash_login_box_content_form basic_form" name="work_login" action="" method="post" enctype="multipart/form-data">
                        ...
                        <label>
                            ...
                            <input class="green" type="email" name="user_email" value="<?= $Cookie ? $Cookie : ''; ?>" placeholder="SEU E-MAIL:" required/>
                        </label>
    
                        <label>
                            <span class="field icon-key">Senha:</span>
                            <input class="green" type="password" name="user_password" placeholder="SUA SENHA:" required/>
                        </label>
                        
                        <a class="dash_login_box_content_pass icon-lock" href="recover.php" title="Esqueci Minha Senha">Esqueci Minha Senha</a>
    
                        <button title="FAZER LOGIN" class="dash_btn green radius">FAZER LOGIN <img class="form_load none" style="margin-left: 6px; margin-bottom: 7px;" alt="Enviando Requisição!" title="Enviando Requisição!" src="_img/load.svg"/></button>
                        <div class="clear"></div>
                    </form>
                </div>
