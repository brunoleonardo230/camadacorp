                ...
                <div class="dash_login_box_content radius">
                    <form class="dash_login_box_content_form basic_form" name="work_login" action="" method="post" enctype="multipart/form-data">
                        ...
                        <label>
                            ...
                            <input class="green" type="password" name="user_password" placeholder="SUA NOVA SENHA" required/>
                        </label>
    
                        <label>
                            <span class="field icon-key">Repita a Nova Senha:</span>
                            <input class="green" type="password" name="user_password_re" placeholder="REPITA SUA NOVA SENHA:" required/>
                        </label>
                        
                        <a class="dash_login_box_content_pass icon-lock" href="./" title="Esqueci Minha Senha">Logar-se!</a>
    
                        <button title="CRIAR NOVA SENHA" class="dash_btn green radius">CRIAR NOVA SENHA <img class="form_load none" style="margin-left: 6px; margin-bottom: 7px;" alt="Enviando Requisição!" title="Enviando Requisição!" src="_img/load.svg"/></button>
                        <div class="clear"></div>
                    </form>
                </div>
