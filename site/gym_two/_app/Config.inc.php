...
if ($_SERVER['HTTP_HOST'] == 'http://camadacorp.com.br'):
    ...
    define('SIS_DB_USER', 'u837848876_gym2'); //Usu�rio do banco de dados no localhost
    define('SIS_DB_PASS', 'f]XAiRK7'); //Senha  do banco de dados no localhost
    define('SIS_DB_DBSA', 'u837848876_gym2'); //Nome  do banco de dados no localhost
else:
    ...
    define('SIS_DB_DBSA', 'gym_two'); //Nome  do banco de dados no servidor
endif;
/*
/*
 * CACHE E CONFIG
