...
if (!$WorkControlDefineConf):
     ...
     * URL DO SISTEMA
     */
    if($_SERVER['HTTP_HOST'] == 'http://camadacorp.test/site/gym_two'):
        define('BASE', 'http://camadacorp.test/site/gym_two'); //Url Raiz do Site no localhost
    else:
        define('BASE', 'http://camadacorp.com.br/site/gym_two'); //Url Raiz do Site no Servidor
    endif;
    define('THEME', 'gym_two'); //Template do Site
endif;
