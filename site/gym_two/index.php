...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Fira+Sans:400,500,600,700,800,900,1200" rel="stylesheet">
    ...
    <link rel="stylesheet" href="<?= INCLUDE_PATH; ?>/assets/css/jquery.bxslider.css">
    ...
    <link rel="stylesheet" href="<?= INCLUDE_PATH; ?>/assets/css/progressbar.css">
...
<body>
    ...
    <?php elseif ($URL[0] == 'coming_soon'): ?>
        <div class="wrapper1">
    <?php else: ?>
        <div class="page-wrapper blogpage2">
    <?php endif; ?>
    <!-- Preloader -->
