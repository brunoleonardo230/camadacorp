<aside itemscope itemtype="http://schema.org/WPSideBar" id=""  class="col-sm-12 col-md-4 col-xs-12 blog_right">
    <article class="search_blog wow fadeInUp animated" data-wow-delay="1s" data-wow-duration="1000ms">
        ...
        <form class="input-group col-md-12 col-sm-12 col-xs-12" name="search" action="" method="post" enctype="multipart/form-data">
            <input type="text" name="s" placeholder="Pesquisar..." class="form-control input-lg" />
            <span class="input-group-btn">
                <button class="btn" type="submit" title="Pesquisar"> <i class="fa fa-search" aria-hidden="true"></i> </button>
            </span>
        </form>
    </article>
    <article class="Categories_blog wow fadeInUp animated" data-wow-delay="300ms"
                ...
                foreach ($Read->getResult() as $Ses):
                    ...
                    <li class="cat_list ">
                        <a title="<?= $Ses['category_title']; ?>" href="<?= BASE; ?>/categorias/<?= $Ses['category_name']; ?>">
                            <span class="cat_name"> <i class="fa fa-circle" aria-hidden="true"></i>
                                <?= $Ses['category_title']; ?>
                            </span>
                            <span class="blog_no pull-right"><?= $totalPosts; ?> </span>
                        </a>
                    </li>
                    <?php
                endforeach;
    ...
    <article class="articles_blog wow fadeInUp animated" data-wow-delay="0ms" data-wow-duration="1000ms">
        ...
        <ul>
            ...
            if (!$Read->getResult()):
                ...
                foreach ($Read->getResult() as $Posts):
                    ...
                    ?>
                    <li class="articles col-sm-12 col-xs-12 colmd-12 wow fadeInRight animated"
    ...
    <article class="tags_blog col-sm-12 col-xs-12 colmd-12 wow zoomIn animated" data-wow-delay="900ms"
             data-wow-duration="1000ms">
